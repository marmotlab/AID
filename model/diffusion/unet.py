...
class GraphUnet1D(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Graph
        # augmented_graph = cond["augmented_graph"]
        # pos_embedding = cond["pos_embedding"]
        # current_position = cond["current_position"]
        # budget = cond["budget"]
        ...
        # flatten history
        state = output_features.view(B, -1)
